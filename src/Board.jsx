...
export default function Board({ xIsNext, squares, onPlay, rows, cols, cells }) {
  function handleClick(i) {
    if (squares[i] || calculateWinner(squares, rows, cols, cells)) {
      return;
    }
  ...
  const winner = calculateWinner(squares, rows, cols, cells);
